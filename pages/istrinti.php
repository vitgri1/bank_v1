...
if ($client['funds'] > 0) { // if not deleted
    $_SESSION['msg'] = ['type' => 'error', 'text' => 'Negalite istrinti saskaitoje pinigu turincio kliento kurio asmens kodas yra: '.$client['client_id']];
} else { // if deleted
    $_SESSION['msg'] = ['type' => 'ok', 'text' => 'Sėkmingai ištrynėte klientą kurio asmens kodas buvo: '.$client['client_id']];
